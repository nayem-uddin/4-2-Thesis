...
fisr = addInput(fisr,[-1 1],'Name','Acceleration');
fisr = addMF(fisr,'Acceleration','trapmf',[-1 -1 -0.4 -0.2],'Name','Negative_Big');
fisr = addMF(fisr,'Acceleration','trimf',[-0.4 -0.2 0],'Name','Negative_Small');
fisr = addMF(fisr,'Acceleration','trimf',[-0.2 0 0.2],'Name','Zero');
fisr = addMF(fisr,'Acceleration','trimf',[0 0.2 0.4],'Name','Positive_Small');
fisr = addMF(fisr,'Acceleration','trapmf',[0.2 0.4 1 1],'Name','Positive_Big');

fisr = addOutput(fisr,[-3 0],'Name','Desired_Acceleration');
fisr = addMF(fisr,'Desired_Acceleration','constant',-3,'Name','Negative_Big');
fisr = addMF(fisr,'Desired_Acceleration','constant',-1.5,'Name','Negative_Small');
fisr = addMF(fisr,'Desired_Acceleration','constant',0,'Name','Zero');
%fisr = addMF(fisr,'Desired_Acceleration','trimf',[0 0.2 0.4],'Name','Positive_Small');
%fisr = addMF(fisr,'Desired_Acceleration','trapmf',[0.2 0.4 1 1],'Name','Positive_Big');
